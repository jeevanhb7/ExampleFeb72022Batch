...
public class ModifyUser {
	...
	private static void modifyUser()
	{
		try
		{
			...
			oBrowser.findElement(By.name("lastName")).sendKeys("sir");
			oBrowser.findElement(By.name("username")).clear();
			oBrowser.findElement(By.name("username")).sendKeys("Jsir07");
			Thread.sleep(4000);
	...
	private static void deleteUser()
	{
		try
		{
			oBrowser.findElement(By.xpath("//span[text()='sir, John']")).click();
			Thread.sleep(4000);
