...
public class ModifyProject {
	...
	private static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("Jeevan");
			oBrowser.findElement(By.id("customerLightBox_descriptionField")).sendKeys("He is from Mysore");
			Thread.sleep(4000);
	...
	private static void createProject()
	{
		try
		{
			...
			Thread.sleep(4000);
			oBrowser.findElement(By.id("projectPopup_projectDescriptionField")).sendKeys("manual testing");
			Thread.sleep(4000);
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(4000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys("End of the project");
			Thread.sleep(4000);
